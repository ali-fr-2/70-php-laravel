...
if (isset($_POST['submit'])) {
  ...
  $result = $connection->prepare("INSERT INTO writers SET username=?,image=? ");
      ...
      <div class="mt-4">
        <ul class="list-unstyled">
          ...
          <li x-data="dropdown" class="sidebar-item active">
            ...
            <ul x-show="open" x-transition class="submenu">
              <li class="submenu-item">
                <a href="writers.php"> افزودن نویسنده </a>
              </li>
            </ul>
          </li>
      ...
      <div class="container">
        <div class="card card-primary bg-light shadow p-4 mt-5">
          ...
          <form action="#" class="mt-4" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <label for="name" class="text-gray-600 fw-bold">نام نویسنده</label>
                <input name="username" id="name" type="text" class="form-control mt-2" />
              </div>
              <div class="col-md-6">
                <label for="name" class="text-gray-600 fw-bold">  عکس نویسنده</label>
            ...
            <div class="d-flex justify-content-end mt-5">
              <button name="submit" type="submit" class="btn btn-primary btn-lg me-3 fs-6">
                <svg
